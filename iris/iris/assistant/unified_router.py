...
- 웹 정보·날씨·뉴스·영화·"~가 뭐야" 조사 → intent=search, lane=search. PC 앱 실행과 혼동 금지.
- 멀티 스텝 PC 조작(열고 보내고, 유튜브에서 X 틀어) → intent=computer_use, lane=computer_use.
...
JSON 스키마(엄격):
{
  ...
  "slots": {"app_key":"","display_name":"","query":"","url":""},
