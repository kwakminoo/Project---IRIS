...
_CUE_VERSION = "mechanical_relay_v1"
...
class SystemSoundPlayer(QObject):
    ...
    def _prepare(self) -> None:
        ...
        cues = {
            ...
            "processing": [(1450, 1450, 0.018, 0.40), (320, 320, 0.028, 0.44), (2450, 2450, 0.012, 0.20)],
            "execute": [(1180, 1180, 0.022, 0.46), (260, 260, 0.04, 0.58), (2880, 2880, 0.014, 0.26)],
            "respond": [(1450, 1450, 0.018, 0.40), (320, 320, 0.028, 0.44), (2450, 2450, 0.012, 0.20)],
